...
class View {
   ...
   * @param {Route} params.route - Route will be passed to [addRoute]{@link View#addRoute}.
   ...
   * Get $selector
   * @method
   * @return {Query} Returns a Query instance of the selector passed in to the constructor.
   */
  get $selector() {

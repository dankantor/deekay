...
export class View {
  ...
  getValue(params, key, defaultValue = null) {
  ...
  show(params) {
    const el = this.getValue(params, 'el');
    if (el !== null) {
      const showClass = this.getValue(params, 'showClass', 'show');
      const hideClass = this.getValue(params, 'hideClass', 'hide');
